	    ...
	    <div class="card-body">
	        <div class="row">
	            <div class="col-sm-12">
	            	...
	            	<form action="{{ route('user.updates') }}" method="POST" class="m-t-15" id="form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                	...
                                	<input type="email" class="form-control" name="email" value="{{ $user && $user->email ? $user->email : '' }}" placeholder="Enter Email" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
